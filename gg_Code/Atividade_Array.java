...
public class Atividade_Array {
    public static void main(String[] args) {
        ...
        Arrays.sort(frutas); //organiza em ordem alfabetica
        int[] numeros2 = {5, 2, 8, 1, 9, 3, 7, 4, 6};
        Arrays.sort(numeros2,2, 9); // organiza do menor pro maior a partir do índice 2, o terceiro número desde o indice 0
